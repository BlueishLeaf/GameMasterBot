...
namespace GameMasterBot.Modules
{
    ...
    public class InfoModule : InteractionModuleBase<SocketInteractionContext>
    {
        ...
        {
            await RespondAsync("You can check the roadmap and source code at: https://github.com/BlueishLeaf/GameMasterBot/projects/1");
        ...
        {
            await RespondAsync("You can check out the source code at: https://github.com/BlueishLeaf/GameMasterBot");
            return CommandResult.AsSuccess();
        }
        ...
        {
            await RespondAsync(embed: BotEmbeds.Overview());
            return CommandResult.AsSuccess();
        }
    }
}
